...
framebuffer_init:
    ...
    MOVZ    W10, #(2 * 4)          // Lower 32 bits => Index 8
    MOVK    X10, #(2 * 4), LSL #32 // Upper 32 bits => Index 9
    MOV     W11, W0                // Lower 32 bits => Index 10
    BFI     X11, X1, #32, #32      // Upper 32 bits => Index 11
    STP     X10, X11, [X9, #32]

    MOVZ    W10, #(MBOX_TAG_SETDEPTH & 0xFFFF)        // Lower 32 bits => Index 12
    MOVK    X10, #(MBOX_TAG_SETPHYWH >> 16), LSL #16
    MOVK    X10, 1 * 4, LSL #32                       // Upper 32 bits => Index 13
    MOV     W11, WZR                                  // Lower 32 bits => Index 14
    BFI     X11, X2, #32, #32                         // Upper 32 bits => Index 15
    STP     X10, X11, [X9, #48]
    ...
    MOV     W11, WZR                                  // Lower 32 bits => Index 18
